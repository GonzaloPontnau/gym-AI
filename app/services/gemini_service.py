...
if GEMINI_API_KEY:
    try:
        ...
        # Definir el modelo a utilizar - usando gemini-2.5-flash que es el modelo más reciente
        # Si este no funciona, ejecuta: python list_gemini_models.py para ver modelos disponibles
        model = genai.GenerativeModel('gemini-2.5-flash')
        GEMINI_CONFIGURED = True
        print("✅ API de Gemini configurada correctamente con modelo gemini-2.5-flash")
